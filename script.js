...
function submitString(concat, tipe, tabel) {
    if (concat.toUpperCase() == "INTERNET" && tipe == "d1") {
        pengulanganTabel(tabel);
    } else if (concat.toUpperCase() == "DROPBOX" && tipe == "m1") {
        pengulanganTabel(tabel);
    } else if (concat.toUpperCase() == "CSS" && tipe == "d2") {
        pengulanganTabel(tabel);
    } else if (concat.toUpperCase() == "MODEM" && tipe == "d3") {
        pengulanganTabel(tabel);
    } else if (concat.toUpperCase() == "TEKS" && tipe == "m2") {
        pengulanganTabel(tabel);
    } else if (concat.toUpperCase() == "SMPT" && tipe == "m3") {
        pengulanganTabel(tabel);
    } else if (concat.toUpperCase() == "HTML" && tipe == "d4") {
        pengulanganTabel(tabel);
    } else if (concat.toUpperCase() == "GOOGLE" && tipe == "m4") {
        pengulanganTabel(tabel);
    } 
}
